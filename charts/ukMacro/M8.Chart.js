...

{
  ...
  "description": "(M8) UK Gov bond rate",

   "title": {
    "text": "Government bonds",
    "subtitle":"Average discount rate, 3-month Treasury Bill. Source: BoE",
    ...
    {"mark": "rule", 
      ...
      "encoding": {
        ...
        "tooltip": [
          ...
          {"field": "Value", "title": "Discount rate", "type": "quantitative", "format": ""}
...
vegaEmbed('#ChartM8', ChartM8, {"actions": false});